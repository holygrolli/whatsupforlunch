prompt_config = {
  ...
  1. Identify the dates the menu is valid for. If there are no dates in the input use the date of today.
  ...
  Today is "Montag" {MC_TODAY} and calendar week {MC_WEEKSTART}.
  """,
  "jsonSchema": """
  {
    "2023-10-30":[
